...
function getModule(moduleName) {
  ...
  try {
    ...
    throw new Error(
      `The transport you've specified for the current mailer needs ${moduleName} but "${moduleName}" is not installed. Please run "npm install ${moduleName}" to install it.`
    )
  }
