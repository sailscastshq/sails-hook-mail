...
const { getTransportClient } = require('./get-transport-client')
  ...
  fn: async function ({
    ...
    switch (sails.config.mail.mailers[mailer]?.transport) {
      case 'smtp':
        ...
        const transporter = getTransportClient(
          {
            transport: 'smtp',
      ...
      case 'mailtrap':
        ...
        const mailtrap = getTransportClient(
          {
            transport: 'mailtrap',
            config: mailtrapClientOptions
          },
      ...
      case 'resend':
        ...
        const resend = getTransportClient(
          {
            transport: 'resend',
            config: { apiKey }
          },
